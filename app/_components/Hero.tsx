            ...
            <header className="h-screen snap-start snap-always">
                <section className="flex flex-col h-full w-full bg-gradient-ground-200">
                    ...
                    <article className="flex flex-col gap-4 md:gap-8 flex-1 justify-center items-center text-center mt-16 md:!mt-32 px-4 md:px-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mt-6 md:!mt-12 w-full sm:w-auto px-4">
                            <Button size="lg" color="secondary" variant="ghost" className="!px-4 w-full sm:w-auto">
                                Registrarse
                            </Button>
                            <Button size="lg" color="secondary" variant="solid" className="!px-4 text-black/90 w-full sm:w-auto">
                                Contacto
                            </Button>
                        </div>
                        <div className="w-full sm:w-4/5 md:w-3/5 lg:w-2/5 h-auto px-4">
                            <Alert variant="solid" color="secondary" title={"Responderemos tus dudas en menos de 24 horas!"} className="w-full mt-8 md:!mt-16 h-auto md:h-15" />
                        </div>
                    </article>
                </section>
            </header>
